...
public:
    ...
    static void SelectVertices(const std::unique_ptr<Object>& object, glm::vec2 start, glm::vec2 end, const glm::mat4& proj, const glm::mat4& view, const glm::vec3& cameraPos);
};